...
export function ImageUploader({ onUploaded, maxImages = 10 }: ImageUploaderProps) {
    const { user } = useAuth();
    ...
    return (
        <div className="space-y-4">
            ...
            >
                ...
                <p className="text-xs text-text-muted">JPEG, PNG, WebP · Max 10MB each</p>
            </div>
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-surface-2 hover:bg-surface-3 text-text-secondary hover:text-text-primary transition-colors text-sm"
            >
                <Camera size={18} />
                Take Photo
            </button>
